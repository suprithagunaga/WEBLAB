...
<head>
    ...
    <style>
        ...
        table{margin:auto;border-collapse:collapse;width:80px;}
        ...
        <body>
            ...
            <table>
                ...
                $students=$conn->query("SELECT * FROM students124")
                ...
                $min=$j;
                    ...
                    echo"<tr><td>{$student['id']}</td><td>{$students['name']}</td><td>{$student['garde']}</td></tr>";
                    }
                    $conn->close();
                    ?>
</table>
